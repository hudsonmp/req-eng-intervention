...
`pickup_location`, `destination`, `fare`, `request_time`, `eta_car`, `eta_destination`, `accessible`, `pickup_distance`, `occupied`, `assigned_other`, `car_cur_location`, `battery_level`, `distance_dropoff`, `predicted_profit`, `num_vehicles`, `num_riders`, `traffic_delay`, `service_radius`, `online`, `cancels`, `batch`, `occupied_assigned_after`